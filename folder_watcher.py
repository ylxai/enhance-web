...
"""
    ...
    parser.add_argument(
        '--no-upload',
        action='store_true',
        help='Disable web upload (hanya processing lokal)'
    )
    ...
    try:
        ...
        if args.no_upload:
            Config.WEB_INTEGRATION["enabled"] = False
            Config.WEB_INTEGRATION["upload_to_web"] = False
            print("🚫 Web upload disabled - processing only local")
