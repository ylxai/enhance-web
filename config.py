...
class Config:
    ...
    GEMINI_MODEL = "gemini-1.5-flash"  # Model yang optimal untuk image enhancement
    ...
    AI_ENHANCEMENT = {
        ...
        "mode": os.getenv("AI_ENHANCEMENT_MODE", "auto"),  # auto | gemini | opencv | disabled
        ...
        1. Untuk area WAJAH (yang sudah di-mask): Hanya lakukan koreksi warna dan penajaman SANGAT HALUS
    ...
    # Watermark Settings
    WATERMARK = {
        "file": "my_logo.png",                   # Nama file watermark
    ...
    # LUT Settings
    LUT_SETTINGS = {
        "file": "my_preset.cube",               # Nama file LUT
    ...
    WEB_INTEGRATION = {
        ...
        "web_api_base_url": os.getenv("WEB_API_BASE_URL", "http://74.63.10.103:3000/api"),
        "web_upload_endpoint": os.getenv("WEB_UPLOAD_ENDPOINT", "http://74.63.10.103:3000/api/photos"),
        "web_event_endpoint": os.getenv("WEB_EVENT_ENDPOINT", "http://74.63.10.103:3000/api/events"),
    ...
    def validate_config(cls):
        ...
        # Check API Key
        if not cls.GOOGLE_API_KEY or cls.GOOGLE_API_KEY == "YOUR_API_KEY_HERE":
